  ...
  dynamic "statement" {
    ...
    content {
      ...
      dynamic "not_principals" {
        for_each = try(statement.value.not_principals != null ? statement.value.not_principals : [], [])
      ...
      dynamic "condition" {
        for_each = try(statement.value.conditions != null ? statement.value.conditions : [], [])
